...
proc import datafile="/home/u61896790/death/nst-est2019-alldata.csv" dbms=csv 
	out=midyear_pop_2014_2019 replace;
	guessingrows=max;
	getnames=yes;
run;
...
proc import datafile="/home/u61896790/death/NST-EST2021-alldata.csv" dbms=csv 
	out=midyear_pop_2020_2021 replace;
	guessingrows=max;
	getnames=yes;
run;
...
/* proc transpose wide to narrow to stack years, make years in population numerical and column=MMWR_Year*/
